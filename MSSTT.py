...
class MSSTT(nn.Module):
    def __init__(self, img_size=17,  in_chans=3, num_classes=1000, embed_dims1=None, depths1=None,
...
if __name__ == '__main__':
        ...
        model = MSSTT(
        in_chans=n_bands, num_classes=16, embed_dims1= [n_bands, 64, 48, 32], depths1=[1, 0, 0, 0],
        num_heads1=[1,0,0,0], 
        attention_heads=[1]*4 + [3]*6 + [8] * 7 + [10] * 7 + [15] * 6,
        use_layer_scale=True, layer_scale_init_value=1e-6, STA1 = 7,STA2 = 3)
        model = model.cuda()
