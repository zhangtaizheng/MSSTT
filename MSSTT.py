...
class MSSTT(nn.Module):
    def __init__(self, img_size=224, patch_size1=16, in_chans=3, num_classes=1000, embed_dims1=None, depths1=None,
                 num_heads1=None, mlp_ratio=4., qkv_bias=True, 
                 drop_rate=0., attn_drop_rate=0., drop_path_rate=0., embed_layer=PatchEmbed, norm_layer=None,
                 act_layer=None, weight_init='',
                 attention_heads=None,
                 use_layer_scale=False, layer_scale_init_value=1e-5, 
                 checkpoint_path=None,STA1 = None,STA2 = None,STA3= None,STA4= None,n_iter=1,qk_scale=None,
                 **kwargs, 
                 ):
        ...
        self.patch_embed = FirstPatchEmbed(in_chans=in_chans, embed_dim=embed_dims1[0])
        self.num_patches1 = num_patches = img_size 
        self.pos_embed1 = nn.Parameter(torch.zeros(1, num_patches, num_patches, embed_dims1[0]))
        self.blocks1 = nn.Sequential(*[
            Block(
                dim=embed_dims1[0], num_heads1=num_heads1[0], mlp_ratio=mlp_ratio, qkv_bias=qkv_bias, drop=drop_rate,
        ...
        self.norm = norm_layer(embed_dims1[0])
        self.head = nn.Linear(embed_dims1[0], num_classes) if num_classes > 0 else nn.Identity()
...
if __name__ == '__main__':
        ...
        model = MSSTT(
        img_size=9, patch_size1=1, in_chans=n_bands, num_classes=16, embed_dims1= [n_bands, 64, 48, 32], depths1=[1, 0, 0, 0],
        num_heads1=[5,0,0,0], mlp_ratio=4., qkv_bias=True, 
        drop_rate=0., attn_drop_rate=0., drop_path_rate=0., norm_layer=None,
        act_layer=None, weight_init='',
        attention_heads=[1]*4 + [3]*6 + [8] * 7 + [10] * 7 + [15] * 6,
        use_layer_scale=True, layer_scale_init_value=1e-6, 
        checkpoint_path=None,STA1 = 7,STA2 = 3,STA3 = 0,STA4 = 0,n_iter=1,qk_scale=None)
        model = model.cuda()
